...
Define a stable and testable retry policy for analyzer LLM calls so transient failures are retried safely while non-retryable failures fail fast and batch processing continues.
